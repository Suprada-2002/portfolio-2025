<script lang="ts">
	...
	import Dock from '$lib/components/Design/Dock.svelte';
	import DockIcon from '$lib/components/Design/DockIcon.svelte';
	import * as Tooltip from '$lib/components/Helpers/Tooltip';
	import Separator from '$lib/components/Helpers/Separator';
	import ModeToggle from './ModeToggle.svelte';
	import Button from '$lib/components/Helpers/Button/button.svelte';
