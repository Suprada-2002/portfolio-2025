<script>
	...
	import WorkCard from "$lib/components/Design/WorkCard.svelte";
			...
			<div class="flex justify-between gap-2">
				<div class="flex flex-1 flex-col space-y-1.5">
					<BlurFade
						...
						yOffset={8}>Hi, I'm Suprada 👋</BlurFade
					>
					<BlurFade class="max-w-[600px] md:text-xl" delay={BLUR_FADE_DELAY}
						>Full Stack Web Developer. I love building things and helping people. Linux Enthusiast.</BlurFade
					>
				</div>
		...
		<div class="flex min-h-0 flex-col gap-y-3">
			...
			<BlurFade delay={BLUR_FADE_DELAY * 2}>
				<ul class="mb-4 ml-4 divide-y divide-dashed border-l">
					{#each DATA.workProfile as project}
						<BlurFade delay={BLUR_FADE_DELAY}>
							<WorkCard {...project} />
						</BlurFade>
					{/each}
